...
KT0915 r;
int main() {
  for ( int i = 4; i < 8; i++ ) pinMode(i, INPUT_PULLUP);
  ...
  do {
    if (digitalRead(5) == LOW) r.setAM(520, 1800, 810, 10); // Switch to AM mode, from 520 to 1800; step 10Khz
    if (digitalRead(6) == LOW) r.setFM(64000, 108000, 106500, 100);
